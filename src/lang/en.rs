...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("desk_tip", "Your desktop is available for remote support with this ID and password."),
        ("connecting_status", "Connecting to the iRidiDesk network..."),
        ...
        ("install_tip", "Due to UAC, iRidiDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install iRidiDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant iRidiDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant iRidiDesk \"Screen Recording\" permissions."),
        ("iridi_permission_screen_title", "Screen & System Audio Recording"),
        ("iridi_permission_screen_text", "Allow iRidiDesk in macOS: Privacy & Security → Screen & System Audio Recording."),
        ("iridi_permission_accessibility_title", "Accessibility"),
        ("iridi_permission_accessibility_text", "Allow iRidiDesk in macOS: Privacy & Security → Accessibility."),
        ("iridi_acceptance_method", "Session acceptance method"),
        ("iridi_verification_method", "Password verification method"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow iRidiDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [iRidiDesk Input] service."),
        ...
        ("doc_mac_permission", "https://irididesk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next iRidiDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant iRidiDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant iRidiDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running iRidiDesk."),
        ...
        ("verify_irididesk_password_tip", "Verify iRidiDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use iRidiDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_irididesk_server_pro_to_{}_tip", "Please upgrade iRidiDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://irididesk.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent iRidiDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Based on RustDesk"),
        ("outgoing_only_desk_tip", "This client is intended only for receiving remote support connections."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if iRidiDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep iRidiDesk background service"),
        ...
        ("upgrade_remote_irididesk_client_to_{}_tip", "Please upgrade the iRidiDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, iRidiDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, iRidiDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, iRidiDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: iRidiDesk server OSS doesn't include this feature."),
        ...
        ("iridi_main_title", "iRidi Remote Support"),
        ("iridi_about_title", "About iRidiDesk"),
        ("iridi_about_based", "Based on RustDesk. Modified for incoming support connections only."),
        ("iridi_about_license", "RustDesk is licensed under GNU AGPLv3."),
        ("iridi_about_source", "Source code for this modified version is provided according to GNU AGPLv3."),
        ("iridi_about_copyright", "Original RustDesk copyright notices are preserved in the source code."),
        ("iridi_about_purpose", "Client for receiving iRidi remote support."),
    ].iter().cloned().collect();
}
