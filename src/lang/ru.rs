...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "Статус"),
        ("Your Desktop", "Удалённая поддержка iRidi"),
        ("desk_tip", "Ваш рабочий стол доступен для удалённой поддержки с этим ID и паролем."),
        ("Password", "Пароль"),
        ("Ready", "Готов"),
        ("Established", "Установлено"),
        ("connecting_status", "Подключение к сети iRidiDesk..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC iRidiDesk может работать неправильно на удалённом узле. Чтобы избежать возможных проблем с UAC, нажмите кнопку ниже для установки iRidiDesk в системе."),
        ("Click to upgrade", "Нажмите, чтобы обновить"),
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить iRidiDesk права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить iRidiDesk права \"снимок экрана\""),
        ("iridi_permission_screen_title", "Запись экрана и системного звука"),
        ("iridi_permission_screen_text", "Разрешите iRidiDesk в macOS: «Конфиденциальность и безопасность → Запись экрана и системного звука»."),
        ("iridi_permission_accessibility_title", "Универсальный доступ"),
        ("iridi_permission_accessibility_text", "Разрешите iRidiDesk в macOS: «Конфиденциальность и безопасность → Универсальный доступ»."),
        ("iridi_acceptance_method", "Способ принятия сеансов"),
        ("iridi_verification_method", "Способ проверки пароля"),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить iRidiDesk использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"iRidiDesk Input\"."),
        ...
        ("Turned off", "Отключён"),
        ("Language", "Язык"),
        ("Keep iRidiDesk background service", "Держать в фоне службу iRidiDesk"),
        ...
        ("Show iRidiDesk", "Показать iRidiDesk"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить iRidiDesk разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить iRidiDesk разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске iRidiDesk."),
        ...
        ("verify_irididesk_password_tip", "Подтвердить пароль iRidiDesk"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать iRidiDesk и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_irididesk_server_pro_to_{}_tip", "Обновите iRidiDesk Server Pro до версии {} или новее!"),
        ...
        ("selinux_tip", "На вашем устройстве включён SELinux, что может помешать правильной работе iRidiDesk на управляемой стороне."),
        ("Change view", "Вид"),
        ...
        ("outgoing_only_desk_tip", "Этот клиент предназначен только для приёма подключений удалённой поддержки."),
        ...
        ("allow-only-conn-window-open-tip", "Разрешать подключение только при открытом окне iRidiDesk"),
        ...
        ("floating_window_tip", "Помогает поддерживать фоновую службу iRidiDesk"),
        ...
        ("upgrade_remote_irididesk_client_to_{}_tip", "Обновите клиент iRidiDesk до версии {} или новее на удалённой стороне!"),
        ...
        ("allow-insecure-tls-fallback-tip", "По умолчанию iRidiDesk проверяет сертификат сервера на наличие протоколов, использующих TLS.\nЕсли эта функция включена, iRidiDesk пропустит данный этап и продолжит работу в случае неудачной проверки."),
        ("Disable UDP", "Отключить UDP"),
        ("disable-udp-tip", "Определяет, следует ли использовать только TCP.\nЕсли включено, iRidiDesk не будет использовать UDP 21116, вместо него будет использоваться TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМЕЧАНИЕ: в OSS-сервере iRidiDesk эта функция отсутствует."),
        ...
        ("iridi_main_title", "Удалённая поддержка iRidi"),
        ("iridi_about_title", "О приложении iRidiDesk"),
        ("iridi_about_based", "Основано на RustDesk. Сборка изменена только для приёма подключений удалённой поддержки."),
        ("iridi_about_license", "RustDesk распространяется по лицензии GNU AGPLv3."),
        ("iridi_about_source", "Исходный код этой модифицированной версии предоставляется в соответствии с GNU AGPLv3."),
        ("iridi_about_copyright", "Оригинальные уведомления об авторских правах RustDesk сохранены в исходном коде."),
        ("iridi_about_purpose", "Клиент для получения удалённой поддержки iRidi."),
    ].iter().cloned().collect();
}
